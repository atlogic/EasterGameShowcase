...
export const TRANSLATIONS: Record<Language, any> = {
  pl: {
    ...
    help: "Pomoc",
    howToPlay: "Jak grać?",
    helpStep1: "Zaloguj się w Panelu Rodzica (ikona zębatki), aby stworzyć własną grę.",
    helpStep2: "Dodaj punkty trasy, zagadki i zadania dla dzieci.",
    helpStep3: "Wydrukuj kody QR i ukryj je w domu lub ogrodzie.",
    helpStep4: "Udostępnij grę innym rodzicom za pomocą kodu QR lub linku.",
    helpStep5: "Dzieci skanują kody, rozwiązują zagadki i świetnie się bawią!",
  ...
  en: {
    ...
    helpStep1: "Log in to the Parent Panel (gear icon) to create your own game.",
    helpStep2: "Add route points, riddles, and tasks for children.",
    helpStep3: "Print QR codes and hide them in your house or garden.",
    helpStep4: "Share the game with other parents using a QR code or link.",
    helpStep5: "Children scan codes, solve riddles, and have great fun!",
